  ...
  <div class="container">
    <div class="row g-4 mb-4">
      ...
      <div class="col-12 col-lg-5">
        <span class="fs-4 fw-bold d-block mb-3" style="letter-spacing: 0.5px;">
      ...
      <!-- Colonne 1 : Destinations -->
      <div class="col-6 col-sm-4 col-lg-2">
        <h5 class="fw-bold mb-3 text-uppercase small" style="letter-spacing: 1px; color: #E86E4D;">Destinations</h5>
      ...
      <!-- Colonne 2 : Services -->
      <div class="col-6 col-sm-4 col-lg-2">
        <h5 class="fw-bold mb-3 text-uppercase small" style="letter-spacing: 1px; color: #E86E4D;">Services</h5>
        <ul class="list-unstyled mb-0">
